...
**Status: minimally maintained for my own Pixel 6 Pro and Pixel Tablet, other devices completely untested by me. Added some code to support Pixel 7/8/..., it builds but not sure if it actually works**
