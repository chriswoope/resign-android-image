...
**Status: minimally maintained for my own Pixel 6 Pro and Pixel Tablet, other devices completely untested by me. Added some code to support Pixel 7/8/..., it builds but not sure if it actually works. Currently working with Android 16 QPR3 builds including both OTA and installation on new devices; it should continue working including with new Android versions until major modifications to the build or OS layout are made**
